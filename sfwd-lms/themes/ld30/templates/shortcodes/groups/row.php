...
<div class="ld-item-list-item ld-expandable ld-item-group-item" id="<?php echo esc_attr( 'ld-expand-' . $group->ID ); ?>">
	<div class="ld-item-list-item-preview ld-group-row">
		...
		<?php if ( $has_content ) : ?>
			<div class="ld-item-details">
				<button
					aria-controls="<?php echo esc_attr( 'ld-group-list-item-' . $group->ID . '-container' ); ?>"
					aria-expanded="false"
					class="ld-expand-button ld-button-alternate"
					data-ld-expands="<?php echo esc_attr( 'ld-group-list-item-' . $group->ID . '-container' ); ?>"
					id="<?php echo esc_attr( 'ld-expand-button-' . $group->ID ); ?>"
				>
	...
	<?php if ( $has_content ) : ?>
		<div
			...
			data-ld-expand-id="<?php echo esc_attr( 'ld-group-list-item-' . $group->ID . '-container' ); ?>"
			id="<?php echo esc_attr( 'ld-group-list-item-' . $group->ID . '-container' ); ?>
		>
